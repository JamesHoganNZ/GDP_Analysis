...
##        
   Unemployed     <- read.csv("HLF000702_20161219_113005_90.csv")
   ...
   ##
     ...
     ##  
        ...
        ##
         ...
         ggsave("Okuns Law - Update for 2016.png",units = "cm", width = 18.65, height = 12.44, dpi=600) 
